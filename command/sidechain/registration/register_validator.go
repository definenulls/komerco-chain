...
func setFlags(cmd *cobra.Command) {
	...
	cmd.MarkFlagsMutuallyExclusive(komerbftsecrets.AccountConfigFlag, komerbftsecrets.AccountDirFlag)
}
...
func runCommand(cmd *cobra.Command, _ []string) error {
	...
	secretsManager, err := komerbftsecrets.GetSecretsManager(params.accountDir, params.accountConfig, true)
	if err != nil {
		return err
	}
