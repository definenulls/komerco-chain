...
import (
	...
	"github.com/definenulls/komerco-chain/command/bridge/common"
	cmdHelper "github.com/definenulls/komerco-chain/command/helper"
...
func createExitTxn(sender ethgo.Address, proof types.Proof) (*ethgo.Transaction, *komerbft.ExitEvent, error) {
	...
	var exitEvent *komerbft.ExitEvent
