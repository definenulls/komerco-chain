...
import (
	...
	"github.com/definenulls/komerco-chain/command/server/config"
	"github.com/definenulls/komerco-chain/command/server/export"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the Komerco Edge client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing Komerco Edge client data",
	)
	...
	cmd.Flags().BoolVar(
		...
		"start the state sync relayer service (KomerBFT only)",
	)
