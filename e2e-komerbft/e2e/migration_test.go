...
import (
	...
	frameworkkomerbft "github.com/definenulls/komerco-chain/e2e-komerbft/framework"
	"github.com/definenulls/komerco-chain/e2e/framework"
...
func TestMigration(t *testing.T) {
	...
	err = frameworkkomerbft.RunEdgeCommand([]string{
		"regenesis",
	...
	cluster := frameworkkomerbft.NewTestCluster(t, 7,
		frameworkkomerbft.WithNonValidators(2),
		frameworkkomerbft.WithValidatorSnapshot(5),
		frameworkkomerbft.WithGenesisState(tmpDir, types.Hash(stateRoot)),
	)
	defer cluster.Stop()
