...
type checkpointManager struct {
	...
	// consensusBackend is abstraction for komerbft consensus specific functions
	consensusBackend komerbftBackend
...
func newCheckpointManager(key ethgo.Key, checkpointOffset uint64,
	...
	blockchain blockchainBackend, backend komerbftBackend, logger hclog.Logger,
