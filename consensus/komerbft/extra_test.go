...
func TestExtra_ValidateFinalizedData_UnhappyPath(t *testing.T) {
	...
	polyBackendMock := new(komerbftBackendMock)
...
func TestExtra_InitGenesisValidatorsDelta(t *testing.T) {
	...
	t.Run("Happy path", func(t *testing.T) {
		...
		komerBftConfig := KomerBFTConfig{InitialValidatorSet: vals.getParamValidators()}
	...
	t.Run("Invalid Extra data", func(t *testing.T) {
		...
		validators := newTestValidators(t, 5)
		komerBftConfig := KomerBFTConfig{InitialValidatorSet: validators.getParamValidators()}
